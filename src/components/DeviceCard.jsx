            ...
            <div className="flex m-4 overflow-hidden bg-gray-50 rounded-lg shadow-md hover:shadow-xl hover:scale-105 transition ease-in-out duration-650 dark:bg-gray-800">
                ...
                <div className="w-full p-4 md:p-4">
                    <h1 className="text-lg font-bold text-gray-800 dark:text-white">
                        {data.device_name} <span className='text-xs px-2 py-0.5 bg-gray-800 text-gray-100 font-semibold rounded-lg'>{data.device_type}</span>
                    </h1>
                    <span className='text-sm text-gray-800 font-semibold'>ID: {data.device_code}</span>
                </div>
            </div>
        </button>
    )
